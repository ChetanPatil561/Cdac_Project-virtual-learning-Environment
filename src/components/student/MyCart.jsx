          ...
          <div class="row d-flex justify-content-center my-4">
            <div class="col-md-8">
              <div className="card mb-4">
                <div className="card-body p-4" style={{backgroundColor:"mistyrose"}}>
            ...
            <div class="col-md-4">
              ...
              <div class="card mb-4" style={{backgroundColor:"aliceblue"}}>
                <div class="card-header py-3 text-center">
                  <h5 class="mb-0">Payment</h5>
                </div>
                <div class="card-body" style={{backgroundColor:"antiquewhite"}}>
