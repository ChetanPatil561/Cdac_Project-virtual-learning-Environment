...
function StudentDashboard() {
  ...
  return (
    <>
      {/* sidebar */}
      <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 sidebar" style={{backgroundColor:"darkgreen"}}>
        ...
        <div class="row mt-5">
          ...
          <div class="col-xl-3 col-sm-6 py-2">
            <div class="card text-white bg-danger h-100">
              ...
              <div class="card-image">
            <img src="https://cdn-icons-png.flaticon.com/512/8019/8019864.png" alt="User Icon" style={{width:"250px"}} />
          </div>
                <div class="rotate">
          ...
          <div class="col-xl-3 col-sm-6 py-2">
            <div class="card text-white bg-info h-100">
              ...
              <div class="card-image">
            <img src="https://cdn-icons-png.flaticon.com/512/2231/2231731.png" alt="User Icon" style={{width:"250px"}} />
          </div>
                <div class="rotate">
                  <i class="fa fa-list fa-4x"></i>
                </div>
          ...
          <div class="col-xl-3 col-sm-6 py-2">
            <div class="card text-white bg-warning h-100">
              <div class="card-body">
              <div class="card-image">
            <img src="https://cdn-icons-png.flaticon.com/512/4403/4403539.png" alt="User Icon" style={{width:"250px"}} />
          </div>
                <div class="rotate">
